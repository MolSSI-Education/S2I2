...
/**
 * invert a real symmetric matrix
 */
void Invert(double*A,long int dim);
/**
 * name mangling dgetri
 */
extern "C" {
void F77NAME(dgetri)(integer &N,doublereal*A,integer&LDA,integer*IPIV,doublereal*WORK,integer&LWORK,integer&INFO);
};
inline void DGETRI(integer &N,doublereal*A,integer&LDA,integer*IPIV,doublereal*WORK,integer&LWORK,integer&INFO)
{
  F77NAME(dgetri)(N,A,LDA,IPIV,WORK,LWORK,INFO);
};
/**
 * name mangling dgetrf
 */
extern "C" {
void F77NAME(dgetrf)(integer&M,integer &N,doublereal*A,integer&LDA,integer*IPIV,doublereal*WORK,integer&LWORK,integer&INFO);
};
inline void DGETRF(integer&M,integer &N,doublereal*A,integer&LDA,integer*IPIV,doublereal*WORK,integer&LWORK,integer&INFO)
{
  F77NAME(dgetrf)(M,N,A,LDA,IPIV,WORK,LWORK,INFO);
};
