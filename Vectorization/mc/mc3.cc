// This version fixes the problem of the dependenced carried by the reduction variable.

// All loops now vectorized!

// Sigh. It is only ~30% faster.  We were hoping for more like 10-fold
// faster?  Why are we not getting that?
